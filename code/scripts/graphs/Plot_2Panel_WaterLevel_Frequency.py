...
PATH = "Teste6-Taxa_Variação_Nível_Água/6C - Esvaziamento Correto"

# Load water level data
df_level = pd.read_csv("./Teste6-Taxa_Variação_Nível_Água/6G - Enchimento/water_level_log.csv")
...
# Load frequency data
df_freq = pd.read_csv("./Teste6-Taxa_Variação_Nível_Água/6G - Enchimento/ipi_frequency_log.csv")
...
fig.update_layout(
    ...
    title="LINCS Dam Draining Test - Water Level and Sampling Frequency Graphs",
    showlegend=True,
